...
parser.add_argument("--atlas_file", type=str, help="gpu id number",
                    dest="atlas_file", default='D:/Software/Xie-registration/voxelmorph/VoxelMorph-torch/LPBA40/fixed.nii.gz')
...
parser.add_argument("--result_dir", type=str, help="results folder",
                    dest="result_dir", default='D:/Software/Xie-registration/voxelmorph/VoxelMorph-torch/Result')

# train时参数
parser.add_argument("--train_dir", type=str, help="data folder with training vols",
                    dest="train_dir", default="D:/Software/Xie-registration/voxelmorph/VoxelMorph-torch/LPBA40/train")
...
parser.add_argument("--model_dir", type=str, help="models folder",
                    dest="model_dir", default='D:/Software/Xie-registration/voxelmorph/VoxelMorph-torch/Checkpoint')
parser.add_argument("--log_dir", type=str, help="logs folder",
                    dest="log_dir", default='D:/Software/Xie-registration/voxelmorph/VoxelMorph-torch/Log')

# test时参数
parser.add_argument("--test_dir", type=str, help="test data directory",
                    dest="test_dir", default='D:/Software/Xie-registration/voxelmorph/VoxelMorph-torch/LPBA40/test')
parser.add_argument("--label_dir", type=str, help="label data directory",
                    dest="label_dir", default='D:/Software/Xie-registration/voxelmorph/VoxelMorph-torch/LPBA40/label')
parser.add_argument("--checkpoint_path", type=str, help="model weight file",
                    dest="checkpoint_path", default="D:/Software/Xie-registration/voxelmorph/VoxelMorph-torch/Checkpoint/LPBA40.pth")
